...
Here is a cool tSNE plot showing a 2-dimensional representation of transcriptome profiles of single cells. The graph describes show similar each cell is to other cells that were profiled:
